---
type: uiux-component
name: Stacked Panels Cursor intereactive component
category: other
tags: [sin-clasificar]
code_type: react
quality_score: 5
created: 2026-05-19 22:46
source: Eira Brain UI/UX Collector
---
# Stacked Panels Cursor intereactive component

**Category:** other | **Type:** react | **Quality:** 5/10

Interactive 3D panel stack built with Framer Motion springs. Mouse position drives per-panel wave lift and scale via a Gaussian falloff curve.
