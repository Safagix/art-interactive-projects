// Holographic color palette (Cyberpunk/Iron Man HUD)
export const COLORS = {
  cyan: '#00f3ff',
  blue: '#0066ff',
  purple: '#bc13fe',
...
// 3D Scene settings
export const SCENE = {
  MAX_OBJECTS: 20, // Increased for assembly
  CAMERA_FOV: 50,
  CAMERA_NEAR: 0.1,
  CAMERA_FAR: 1000,
  CAMERA_Z: 10,
  OBJECT_DEPTH: 0.2,           // Thinner panels for holograms
  SUBDIVISION_LEVEL: 1,        // Less subdivision for sharper edges
  INFLATION_AMOUNT: 0.05,      // Very little inflation, keep it flat/angular
  BOB_AMPLITUDE: 0.05,         // More stable holograms
  BOB_SPEED_MIN: 0.2,
  BOB_SPEED_MAX: 0.8,
  ROTATION_SPEED_MAX: 0.1,     // Slower rotation
  DRIFT_SPEED: 0.005,          // Minimal drift
  COLLISION_RADIUS: 1.5,
  SNAP_DISTANCE: 1.2           // Distance to snap objects together
};
...
export const BACKGROUND = {
  COLOR_START: '#0a0f12',  // Very dark slate/blue
  COLOR_END: '#020406'     // Almost black
};
