...
/**
 * NexusBackground — Purple/Cyan Neural Vortex WebGL shader.
 * Variant of NeuralBackground with the original 21dev color palette
 * for The Nexus hub identity.
 */
    ...
    useEffect(() => {
        ...
        const fsSource = `
            ...
            void main() {
                ...
                // Purple/Cyan palette (original 21dev colors)
