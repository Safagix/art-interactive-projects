...
export function NeuralBackground() {
    ...
    `;
      ...
      void main() {
        ...
        // Colors specific to ProfessionalStats (Aero Blue/Neon)
        color = vec3(0.0, 0.3, 0.6); // Base dark blue
        color = mix(color, vec3(0.3, 0.8, 1.0), 0.32 + 0.16 * sin(2.0 * u_scroll_progress + 1.2)); // Light blue highlight
        color += vec3(0.1, 0.5, 0.9) * sin(2.0 * u_scroll_progress + 1.5);
        color = color * noise;
